...
$sql1 = "SELECT DISTINCT count(estado) as pendente FROM sugestao, clientes_assistencia WHERE clientes_assistencia.id = sugestao.cliente_id AND sugestao.estado = 'Pendente'";
...
$sql2 = "SELECT DISTINCT count(estado) as analise FROM sugestao, clientes_assistencia WHERE clientes_assistencia.id = sugestao.cliente_id AND sugestao.estado = 'Analise'";
...
$sql3 = "SELECT DISTINCT count(estado) as teste FROM sugestao, clientes_assistencia WHERE clientes_assistencia.id = sugestao.cliente_id AND sugestao.estado = 'Teste'";
...
$sql4 = "SELECT DISTINCT count(estado) as concluido FROM sugestao, clientes_assistencia WHERE clientes_assistencia.id = sugestao.cliente_id AND sugestao.estado = 'Concluido'";
...
$obter_comp="SELECT admins.nome FROM admins, sugestao WHERE sugestao.user_id = admins.id AND sugestao.id = $id";
